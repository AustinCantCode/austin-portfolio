    ...
    const content = (
      ...
      >
        ...
        <TimelineContent>
          ...
          <TimelineSubtext>{subtext}</TimelineSubtext>
...
const TimelineTime = React.forwardRef<HTMLTimeElement, TimelineTimeProps>(
  ({ className, startDate, endDate, format, children, ...props }, ref) => {
    ...
    return (
      <time
        ref={ref}
        dateTime={startDate ? new Date(endDate).toISOString() : undefined}
        className={cn(
...
const TimelineSubtext = React.forwardRef<
  HTMLParagraphElement,
  React.HTMLAttributes<HTMLParagraphElement>
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("max-w-sm text-base text-white", className)}
    {...props}
  />
));
TimelineSubtext.displayName = "TimelineSubtext";
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col text-left gap-2 pl-2", className)}
    {...props}
  />
));
